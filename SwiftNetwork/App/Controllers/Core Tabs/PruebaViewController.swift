...
class PruebaViewController: UIViewController /*, SkeletonDisplayable*/ {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        ///collectionViewTwo.isSkeletonable = true
        ///collectionViewTwo.showAnimatedGradientSkeleton(usingGradient: .init(baseColor: .link), animation: nil, transition: .crossDissolve(0.25))
        ///showSkeleton()
    ...
    private func setupModel(with model: [Userpost] ) {
        ...
        //DispatchQueue.main.asyncAfter(deadline: .now() + 3) {
            SpinnerView.shared.spinner.stopAnimating()
            SpinnerView.shared.VW_overlay.isHidden = false
            ///self.collectionViewTwo.stopSkeletonAnimation()
...
extension PruebaViewController: UICollectionViewDelegate, UICollectionViewDataSource, /*SkeletonCollectionViewDataSource,*/ UICollectionViewDelegateFlowLayout {
